describe('incidences', function() {
    ...
    describe('adcdefg edges explicit outward', function() {
        beforeEach(function() {
            nodes = [
                {key: 'a', value: {outs: ['b', 'c']}},
                {key: 'b'},
                {key: 'c', value: {n: 17, outs: 'd'}},
                {key: 'd'}
            ];
            graph = metagraph.graph_incidence(nodes);
        });
    ...
    describe('adcdefg edges explicit inward', function() {
        beforeEach(function() {
            nodes = [
                {key: 'a'},
                {key: 'b', value: {ins: 'a'}},
                {key: 'c', value: {n: 17, ins: 'a'}},
                {key: 'd', value: {ins: 'c'}}
            ];
            graph = metagraph.graph_incidence(nodes);
        });
